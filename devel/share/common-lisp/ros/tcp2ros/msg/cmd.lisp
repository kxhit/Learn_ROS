...
(cl:defmethod cl:initialize-instance :after ((m <cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcp2ros-msg:<cmd> is deprecated: use tcp2ros-msg:cmd instead.")))

(cl:ensure-generic-function 'Velocity-val :lambda-list '(m))
(cl:defmethod Velocity-val ((m <cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcp2ros-msg:Velocity-val is deprecated.  Use tcp2ros-msg:Velocity instead.")
  (Velocity m))

(cl:ensure-generic-function 'Turn-val :lambda-list '(m))
(cl:defmethod Turn-val ((m <cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcp2ros-msg:Turn-val is deprecated.  Use tcp2ros-msg:Turn instead.")
  (Turn m))
